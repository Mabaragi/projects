...
while True:
    ...
    target_x = targetBall_x + 5.7 * (targetBall_x - target_hole_x) / hole_distance
    target_y = targetBall_y + 5.7 * (targetBall_y - target_hole_y) / hole_distance
